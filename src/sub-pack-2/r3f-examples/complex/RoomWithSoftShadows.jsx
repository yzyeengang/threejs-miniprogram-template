...
import { SoftShadows, Float, Sky, OrbitControls, PerformanceMonitor, useGLTF } from "@react-three/drei"
...
function Light() {
  ...
  useFrame((state, delta) => {
    ...
    easing.dampE(ref.current.rotation, [(pointer[1] * Math.PI) / 50, (pointer[0] * Math.PI) / 20, 0], 0.2, delta)
  })
  return (
    <group ref={ref}>
...
export function RoomWithSoftShadowsApp({ eventSource }) {
  ...
  return (
    <Canvas shadows eventSource={eventSource} dpr={[1,THREEGlobals.devicePixelRatio]} camera={{ position: [5, 2, 10], fov: 50 }}>
...
export function Room(props) {
  const { nodes, materials } = useGLTF(`${CDN_PREFIX}/room-transformed_png-texture.glb`, "draco/gltf/")
  return (
