import { game, UseCanvasResult } from '@minisheep/three-platform-adapter';
...
export function init({ canvas, useFrame, recomputeSize }: UseCanvasResult<WechatGameTouchCanvas, true>) {
