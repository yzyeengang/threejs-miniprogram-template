...
import type { WechatGameTouchCanvas } from "@minisheep/three-platform-adapter/wechat-game";
...
export function init({ canvas, useFrame }: UseCanvasResult<WechatGameTouchCanvas, true>) {
  ...
  if(!supportedFloatType) {
    throw new Error('需要设备支持 EXT_color_buffer_float')
  }
